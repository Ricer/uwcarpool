...
if (isset($_POST['firstname'],$_POST['lastname'], $_POST['email'], $_POST['p'])) {
    ...
    // firstname validity and password validity have been checked client side.
    ...
    if (empty($error_msg)) {
        ...
        if ($insert_stmt = $mysqli->prepare("INSERT INTO members (firstname, lastname, email, password, salt) VALUES (?, ?, ?, ?, ?)")) {
