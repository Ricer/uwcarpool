...
function formhash(form, password) {
    var p = $("<input type='hidden' name='p' value=''>");
...
$(function(){
    $("form[data-trigger='checker']").submit(function(e){
        ...
        if($(this).find('input[data-hash="true"]').length>1) console.log("!! more than one input with data-hash enabled. hashing first one.");
        if($(this).find('input[data-hash="true"]')){
           formhash(this, $(this).find('input[data-hash="true"]').get(0));
        }
        return true;
    })
})